...
public class ListViewSingleActivity extends AppCompatActivity {
    ...
    private void init() {
        lisetView = (ListView) findViewById(R.id.listview_single);
        datas = new ArrayList<>();
        btn_listview_single = (Button) findViewById(R.id.btn_listview_single);
        ...
        lisetView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                int checkedItemPosition = lisetView.getCheckedItemPosition();
                Toast.makeText(ListViewSingleActivity.this, "position==" + checkedItemPosition, Toast.LENGTH_SHORT).show();
            }
        });

        btn_listview_single.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int checkedItemPosition = lisetView.getCheckedItemPosition();
                InvestBean bean = datas.get(checkedItemPosition);
                T.showShort(ListViewSingleActivity.this, "单选：" + bean.getName());
            }
        });
    }
